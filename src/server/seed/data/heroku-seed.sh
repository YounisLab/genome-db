...
psql `heroku config:get DATABASE_URL` -c \
"CREATE TABLE MCF_INTRON_PSI ( gene VARCHAR, intron_number INT CHECK (intron_number > 0), mcf10a_psi FLOAT, mcf7_psi FLOAT, mcf10a_log2_psi FLOAT, mcf7_log2_psi FLOAT );"
